...
module.exports = class GuildCreateEvent extends BaseEvent {
  ...
  async run(client, guild) {
      ...
      console.log(`The ( ${client.user.tag} ) has left from this server ( ${guild} ) [ ${guild.id} ] with this owner [ ${guild.owner} ]`);
      ...
      memberCountChannel.send(`The ( ${client.user.tag} ) has left from this server ( ${guild} ) [ ${guild.id} ] with this owner [ ${guild.owner} ]`)
